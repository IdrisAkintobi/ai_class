...
You will build a decision tree model to predict customer churn.
"""
...
data = {
    ...
    "MonthlyCharge": [50, 60, 70, 80, 90, 100, 110, 120, 130, 140]
    * 10,  # Monthly bill amount
    "CustomerServiceCalls": [1, 2, 3, 4, 0, 1, 2, 3, 4, 0]
